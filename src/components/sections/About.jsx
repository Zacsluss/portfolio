    ...
    >
      ...
      <div className="about-container">
        ...
        <div className="about-actions">
          ...
          <a href="#experience" className="action-button" onClick={handleSmoothScroll}>
            <svg className="button-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="about-social">
          <a href={portfolioData.social.github} target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="GitHub">
