export const portfolioData = {
  personal: {
    ...
    bio: "I design and lead enterprise technology ecosystems that scale globally, driving measurable transformation across Fortune 500-scale operations. Currently governing technology portfolios exceeding $10M in annual value, I orchestrate CRM, data, and cloud ecosystems spanning 20+ countries with proven ROI and compliance excellence.\n\nMy approach centers on translating enterprise complexity into strategic clarity—aligning Salesforce multi-cloud architecture, API-led integration frameworks, and data governance with board-level growth objectives. I've delivered 40%+ productivity gains, automated 1,000+ hours annually, and maintained 100% SOX compliance across global operations.\n\nBy day, I govern $1M+ CRM portfolios and direct $3M+ vendor ecosystems while driving digital transformation for thousands of global users. By night, I build particle systems at 60 FPS, experiment with AI/ML projects, and capture 360° aerial worlds. The best technology leaders are creators at heart—curious, hands-on, and driven to make systems not just efficient, but transformative.",
  ...
  skills: [
    {
      ...
      skills: [
        ...
        { name: "Enterprise Technology Strategy & Governance", level: "Expert", years: 5 },
        { name: "Capital Planning & Budget Oversight", level: "Expert", years: 4 },
        { name: "Vendor Portfolio Strategy & Contract Negotiation", level: "Expert", years: 5 },
        { name: "Platform Integration & Roadmap Ownership", level: "Expert", years: 5 },
        { name: "Enterprise Platform Governance", level: "Expert", years: 4 },
        { name: "Data Governance & Analytics Monetization", level: "Expert", years: 5 },
        { name: "API-Led Architecture", level: "Expert", years: 4 },
      ],
    },
    {
      category: "Enterprise CRM & Business Platforms",
      skills: [
        { name: "Salesforce Multi-Cloud (Certified)", level: "Expert", years: 4, certified: true },
        { name: "Salesforce Sales Cloud", level: "Expert", years: 4 },
        { name: "Salesforce Service Cloud", level: "Expert", years: 4 },
        { name: "Salesforce Experience Cloud", level: "Expert", years: 3 },
        { name: "Salesforce CPQ", level: "Expert", years: 4 },
        { name: "Salesforce Data Cloud", level: "Expert", years: 3 },
        { name: "Salesforce Flow", level: "Expert", years: 4 },
        ...
        { name: "HubSpot", level: "Advanced", years: 3 },
        { name: "Zoho CRM", level: "Advanced", years: 2 },
        ...
        { name: "ServiceNow & Flow Designer", level: "Advanced", years: 3 },
        { name: "Microsoft Power Platform", level: "Advanced", years: 3 },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "Application Integration & Data Orchestration", level: "Expert", years: 5 },
        { name: "SQL", level: "Expert", years: 7 },
        { name: "Snowflake", level: "Advanced", years: 2 },
        { name: "Google BigQuery", level: "Advanced", years: 3 },
        { name: "Oracle Database", level: "Advanced", years: 5 },
      ],
    },
    {
      category: "Analytics & Business Intelligence",
      skills: [
        { name: "Tableau (Certified)", level: "Expert", years: 5, certified: true },
    ...
    },
    {
      ...
      skills: [
        { name: "AWS (Certified)", level: "Expert", years: 4, certified: true },
        { name: "Microsoft Azure & DevOps", level: "Advanced", years: 3 },
        { name: "Google Cloud Platform (GCP)", level: "Advanced", years: 2 },
        { name: "Docker", level: "Advanced", years: 3 },
        { name: "Kubernetes", level: "Advanced", years: 2 },
        { name: "Infrastructure as Code (CloudFormation, Terraform)", level: "Advanced", years: 3 },
        { name: "Cloud Architecture & Transformation", level: "Expert", years: 4 },
      ],
    },
    {
      category: "Enterprise Automation & AI/ML",
      skills: [
        { name: "AI/ML Enablement & Enterprise Automation", level: "Expert", years: 3 },
        { name: "UiPath", level: "Advanced", years: 3 },
        { name: "Blue Prism", level: "Advanced", years: 2 },
        { name: "Power Automate", level: "Advanced", years: 3 },
        { name: "Workato", level: "Advanced", years: 2 },
        { name: "Pipedream", level: "Advanced", years: 2 },
        { name: "Make (Integromat)", level: "Advanced", years: 2 },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "GDPR & CCPA", level: "Expert", years: 4 },
        { name: "Zero Trust Architecture", level: "Advanced", years: 3 },
        { name: "Data Loss Prevention (DLP)", level: "Advanced", years: 3 },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Enterprise Architecture Frameworks", level: "Expert", years: 4 },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "Microsoft Teams", level: "Advanced", years: 4 },
