export const portfolioData = {
  personal: {
    ...
    bio: "Delivering 40%+ productivity gains, unifying 3,000+ global users across 22+ countries, and governing $5M+ annual platform budgets. Expert in Salesforce multi-cloud, API-led integration, enterprise data strategy, and digital transformation program leadership to better align technology investments to board-level growth objectives. I govern $5M+ CRM ecosystems by day, build particle systems at 60 FPS by night, and believe the best technology leaders never stop creating. Multi-passionate about AI/ML, digital art, music production, and 360° drone photography — because curiosity makes better strategists.",
  ...
  experience: [
    {
      ...
      achievements: [
        "Led global digital transformation program increasing sales and operational throughput 40%, automating 1,000+ hours annually, and standardizing processes worldwide through API-led integration and governance frameworks",
        "Achieved 100% SOX audit readiness and maintained zero compliance breaches by instituting enterprise-wide governance model",
        "Increased deal velocity 30% by designing and governing global managed services pricing platform with standardized product/pricing models and embedded automation logic",
        "Owned and executed platform roadmap ensuring alignment with multi-year business strategy, M&A integrations, and global market expansion objectives",
        "Enabled board-level decision-making by delivering Salesforce dashboards for real-time forecasting, pipeline insights, and revenue tracking",
        "Global Change Management Leadership - serve as single point of authority for all global Salesforce change management initiatives, directing adoption, process alignment, and stakeholder engagement across 22+ countries",
        "Provide matrix leadership across 12 global cross-functional teams with oversight of $3M+ vendor portfolio spanning 11 contracts in CRM, integration, analytics, and automation categories",
        "Manage portfolio of 12+ concurrent strategic projects annually ensuring enterprise alignment and on-time delivery across all business units",
      ],
    ...
    },
    {
      ...
      startDate: "2019-09",
      endDate: "2021-10",
      description: "Directed $46M+ national syndicate business cash loan program with zero compliance incidents, optimizing portfolio yield while ensuring operational precision.",
      achievements: [
        "Reduced approval cycles 35% by deploying cloud-based loan origination platform integrating analytics, compliance, and CRM systems, delivering instant executive reporting",
        "Cut new-hire ramp time 80% by overhauling training and process frameworks for nationwide coordinator team, increasing operational consistency",
        "Partnered with senior leadership to identify and implement automation initiatives that enhanced risk oversight and accelerated funding timelines",
      ],
    ...
    },
    {
      ...
      startDate: "2018-06",
      endDate: "2019-07",
      description: "Directed technology-driven credit risk evaluation program integrating SQL and Oracle-based analytics into compliance and decision-making workflows.",
      achievements: [
        "Cut underwriting turnaround time 60% and increased accuracy by designing automated scoring and data-cleansing models for specific merchant portfolio types",
        "Partnered with IT and compliance teams to integrate risk systems with core processing platforms, supporting $10B+ annual transaction volume and aligning with enterprise architecture standards",
    ...
    },
    {
      ...
      startDate: "2017-03",
      endDate: "2021-03",
      description: "Founded and scaled multi-channel e-commerce and digital services venture, generating six-figure cumulative revenue.",
      achievements: [
        "Generated six-figure cumulative revenue by founding and scaling multi-channel e-commerce and digital services ventures, leveraging automation, analytics, and creative production",
        "Delivered advanced aerial mapping, 3D modeling, and commercial media as FAA-licensed remote pilot, serving diverse commercial clients",
        "Designed operational and digital commerce framework for upcoming trading card & board game business (planned launch 2026)",
      ],
      technologies: ["E-commerce Platforms", "Digital Marketing", "Drone Technology", "3D Modeling", "Business Analytics"],
    },
  ],
  projects: [
    {
  ...
  skills: [
    {
      ...
      skills: [
        { name: "Salesforce Multi-Cloud", level: "Expert", years: 4 },
        { name: "Salesforce CPQ", level: "Expert", years: 4 },
        { name: "Salesforce Data Cloud", level: "Expert", years: 3 },
        { name: "Salesforce Marketing Cloud", level: "Advanced", years: 3 },
        { name: "Marketo", level: "Advanced", years: 3 },
        { name: "Pardot", level: "Advanced", years: 3 },
        { name: "Workday HCM", level: "Advanced", years: 3 },
        { name: "SAP ERP", level: "Advanced", years: 3 },
        { name: "Oracle Cloud Apps", level: "Advanced", years: 4 },
        { name: "ServiceNow", level: "Advanced", years: 3 },
      ],
    },
    {
      category: "Integration & Data Platforms",
      skills: [
        { name: "MuleSoft", level: "Expert", years: 3 },
        { name: "API Management (Apigee, Kong)", level: "Expert", years: 4 },
        { name: "SQL", level: "Expert", years: 6 },
        { name: "Snowflake", level: "Advanced", years: 2 },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Looker", level: "Advanced", years: 2 },
        { name: "Google Analytics", level: "Advanced", years: 5 },
    ...
    },
    {
      ...
      skills: [
        { name: "AWS", level: "Expert", years: 3 },
        { name: "Microsoft Azure & DevOps", level: "Advanced", years: 3 },
        { name: "Google Cloud Platform", level: "Advanced", years: 2 },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "Splunk", level: "Advanced", years: 3 },
        { name: "CrowdStrike", level: "Advanced", years: 2 },
        { name: "Palo Alto Prisma Cloud", level: "Advanced", years: 2 },
      ],
    },
    {
      category: "Governance & Compliance",
      skills: [
        { name: "SOX Compliance", level: "Expert", years: 3 },
        { name: "GDPR", level: "Advanced", years: 3 },
        { name: "CCPA", level: "Advanced", years: 3 },
    ...
    },
    {
      ...
      skills: [
        { name: "TOGAF", level: "Advanced", years: 3 },
        { name: "Zachman Framework", level: "Advanced", years: 2 },
        { name: "Jira", level: "Expert", years: 5 },
        { name: "Confluence", level: "Advanced", years: 5 },
      ],
    },
    {
  ...
  additionalLinks: [
    // AI & Technology (alphabetically sorted)
    {
      id: "link-10",
    ...
    // Art & Design (alphabetically sorted)
    {
      id: "link-2",
