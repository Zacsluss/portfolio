export const portfolioData = {
  personal: {
    ...
    bio: "Enterprise Technology Leader specializing in multi-million-dollar CRM, ERP, and Data ecosystems for Fortune 500-scale enterprises—delivering 40%+ productivity gains and governing global multi-cloud portfolios across 20+ countries. I govern technology portfolios exceeding $10M in annual value, driving global transformation across CRM, data, and cloud ecosystems with measurable ROI and compliance assurance.\n\nBy day, I architect Salesforce ecosystems and negotiate million-dollar vendor contracts. By night, I build particle physics simulations at 60 FPS and pilot drones through impossible angles. Turns out optimizing enterprise workflows and rendering 30,000 particles in real-time require the same obsessive attention to performance—I just get to crash fewer servers when experimenting with the fun stuff.",
